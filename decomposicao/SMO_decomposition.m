function [GERAL] = SMO_decomposition(DATASET,PARAMETERS)
%% parametros
kmax = 1000000;
k =0;
...
Q_diag = [];
for k = 1:n
    Q_diag(k,1) = makingKernelFunction(PARAMETERS,DATASET.X_train(k,:),[]);
end
...
while criterio
    ...
    [i,j,Q,a,b] = workingSet_SMO(PARAMETERS,n,C,DATASET.X_train,y_train,Q_diag,alphak,gradAlpha);
